...
class RepositorioVocabulario {
  ...
  static List<Pictograma> obtenerPalabrasFrecuentes() {
    return [
      Pictograma(palabra: 'Yo', rutaImagen: "assets/images/yo.jpg", categoria: CategoriaCAA.persona),
      Pictograma(palabra: 'Tú', rutaImagen: "assets/images/tu.jpg", categoria: CategoriaCAA.persona),
      Pictograma(palabra: 'Él', rutaImagen: "assets/images/el.jpg", categoria: CategoriaCAA.persona),
      Pictograma(palabra: 'Ella', rutaImagen: "assets/images/ella.jpg", categoria: CategoriaCAA.persona),
      Pictograma(palabra: 'Nosotros', rutaImagen: "assets/images/nosotros.jpg", categoria: CategoriaCAA.persona),
      Pictograma(palabra: 'Profesora', rutaImagen: "assets/images/profesora.jpg", categoria: CategoriaCAA.persona),
      Pictograma(palabra: 'Papá', rutaImagen: "assets/images/papa.jpg", categoria: CategoriaCAA.persona),
      Pictograma(palabra: 'Mamá', rutaImagen: "assets/images/mama.jpg", categoria: CategoriaCAA.persona),
      Pictograma(palabra: 'Amigos', rutaImagen: "assets/images/amigos.jpg", categoria: CategoriaCAA.persona),
